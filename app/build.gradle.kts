...
android {
    ...
    defaultConfig {
        ...
        defaultConfig {
            buildConfigField("String", "ONLINE_PLUGINS_FOLDER", "\"${System.getenv("ONLINE_PLUGINS_FOLDER")}\"")
            buildConfigField("String", "REPO_URL", "\"${System.getenv("REPO_URL")}\"")
            buildConfigField("String", "REPO_NAME", "\"${System.getenv("REPO_NAME")}\"")
